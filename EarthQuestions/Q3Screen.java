...
public class Q3Screen extends JPanel implements QInterface{
	...
	String[] question = new String[]{"Who is allowed to recycle?"
			, "C", "A. Your teachers", "B. Your best friend ", "C. Everyone"};


	//String containing the fun fact that the user will see after
	//they correctly answer the question
	String funFact = "Make sure to sort through your garbage \nand head to the recycling center!";
