...
public class Q4Screen extends JPanel implements QInterface{
	...
	String[] question = new String[]{" How much junk mail do Americans receive in one day?", "A", 
			"A. Enough to heat 250,000 homes", "B. Enough to power a TV for one year ", 
	"C. Enough to fill 10sq. miles in a landfill"};

	//String containing the fun fact that the user will see after
	//they correctly answer the question
	String funFact = "The average American spends 8 months of their lives opening "
			+ "\njunk mail, so save your time and some trees and recycle that paper!";
