...
public class Q5Screen extends JPanel implements QInterface{
	...
	String[] question = new String[]{" The average aluminum can is made up of how much recycled aluminum?", 
			"B", "A. 30%", "B. 50%", "C. 70%"};

	//String containing the fun fact that the user will see after
	//they correctly answer the question
	String funFact = "Last year alone, the 36 billion aluminum cans landfilled"
			+ "\nhad a scrap value of more than $600 million. If we don\'t recycle"
			+ "\nthem, someday we\'ll be mining our landfills for the resources"
			+ "\nwe\'re burying.";
