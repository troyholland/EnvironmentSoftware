...
public class Q6Screen extends JPanel implements QInterface{
	...
	String[] question = new String[]{" How many plastic bottles do Americans go through every year? ",
			"C", "A. 1.8 million", "B. 5.3 million ", "C. 2.5 million"};

	//String containing the fun fact that the user will see after
	//they correctly answer the question
	String funFact = " If every American household recycled just one out of every ten "
			+ "\nof the plastic bottles they used, we\'d keep 200 million pounds of plastic"
	 ...
	 * @param basePanel
	 */
	public Q6Screen(AppletMain appletParameter, QuestionPanel basePanel)
	{
