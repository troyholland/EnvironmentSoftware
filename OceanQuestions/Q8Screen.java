...
public class Q8Screen extends JPanel implements QInterface{
	...
	String[] question = new String[]{"How many times can glass be recycled?", "B", "A. Once ", "B. Forever", 
	"C. None, glass can\'t be recycled!"};

	//String containing the fun fact that the user will see after
	//they correctly answer the question
	String funFact = "The amazing thing about glass: it never wears out!";
	 ...
	 * @param basePanel
	 */
	public Q8Screen(AppletMain appletParameter, QuestionPanel basePanel)
	{
