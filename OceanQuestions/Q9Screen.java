...
public class Q9Screen extends JPanel implements QInterface{
	...
	String[] question = new String[]{"Recycling just one aluminium can saves enough energy to run a television "
			+ "for how long?", "C", "A. 30 minutes", "B. 12 hours",  "C. 3 hours"};

	//String containing the fun fact that the user will see after
	//they correctly answer the question
	String funFact = "Every minute of every day, an average "
			+ "\nof 113,200 aluminium cans are recycled.";
	 ...
	 * @param basePanel
	 */
	public Q9Screen(AppletMain appletParameter, QuestionPanel basePanel)
	{
